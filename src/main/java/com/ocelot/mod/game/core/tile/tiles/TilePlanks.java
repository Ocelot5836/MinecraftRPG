...
public class TilePlanks extends Basic3DTile {
	...
	public TilePlanks(int id) {
		super(id, "planks", "planks", null);
	}
	...
	public IBlockState getState(TileMap tileMap, int x, int y, int layer) {
		...
		return Blocks.PLANKS.getDefaultState().withProperty(BlockPlanks.VARIANT, type);
	}
}